...
public class PreguntasFaciles extends Preguntas{
    public PreguntasFaciles(){
        setTextoBaseDePreguntas(
      
    "¿Dónde está ubicada la Casa Blanca?\tWashington D.C.\tNueva York\tCalifornia\tFlorida\tTexas"
    + "\n" +
